...
class WebsiteNotPermittedException extends \Exception
{
	/** @var string|null */
	private $site;

	/**
	 * WebsiteNotPermittedException constructor.
	 *
	...
	public function __construct(string $site = null, \Exception $previous = null)
	{
		...
		$message = '';
		if ($site) {
			$message = sprintf("Unable to load website '%s': Permission denied", $site);
		} elseif ($previous) {
