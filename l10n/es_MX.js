OC.L10N.register(
    ...
    "To add a custom template, you will need to create a new folder in apps/cms_pico/templates/" : "Para agregar una plantilla personalizada, necesitas crear una nueva carpeta en /apps/cms_pico/templates/",
    "Please use the sample_pico base structure: your template will need the config/ folder to be identical." : "Por favor usa la estructura base sample_pico: tu plantilla necesitará que la carpeta config/ sea idéntica.",
    ...
    "The title of your website" : "El título de tu sitio web",
    "My new site folder" : "La carpeta de mi nuevo sitio ",
