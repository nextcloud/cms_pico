OC.L10N.register(
    ...
    {
    "Copy" : "Kopieren",
    "Confirm website deletion" : "Möchtest Du die Webseite löschen?",
    ...
    "Failed to enable Pico CMS for Nextcloud: Couldn't find \"%s\". Make sure to install the app's dependencies by executing `composer install` in the app's install directory below \"%s\". Then try again enabling Pico CMS for Nextcloud." : "Konnte Pico CMS für Nextcloud nicht aktivieren: Die Datei \"%s\" konnte nicht gefunden werden. Stelle sicher, dass die Abhängigkeiten der App installiert wurden indem Du `composer install` im Installationsverzeichnis der App unter \"%s\" ausführst. Versuche es anschließend erneut.",
    ...
    "If you wish not to enable all of your users to create personal websites, you can limit Pico CMS for Nextcloud to certain groups. Select the groups you want to limit access to. If you leave this field empty, usage isn't limited. Revoking access for certain groups won't delete any of a user's websites, however, they get inaccessible." : "Wenn du nicht allen Benutzern ermöglichen möchtest persönliche Webseiten zu erstellen, kannst du die Nutzung von Pico CMS for Nextcloud auf bestimmte Gruppen beschränken. Wähle hierzu in der Liste die Gruppen aus, auf die du die Nutzung beschränken möchtest. Wenn du die Liste leer lässt, wird die Nutzung nicht beschränkt. Wenn du einer Gruppe das Recht zur Nutzung von Pico CMS for Nextcloud entziehst, werden keine Webseiten gelöscht, sie werden lediglich unzgänglich.",
    ...
    "You want to learn more about Pico CMS for Nextcloud? Easy! Just create your first personal website using the \"sample_pico\" template. Pico's sample contents will explain all you need to know…" : "Du willst mehr über Pico CMS für Nextcloud erfahren? Das ist ganz einfach! Erstelle jetzt Deine erste persönliche Webseite unter Verwendung der \"sample_pico\"-Vorlage. Diese Beispielinhalte erläutern alles was Du wissen musst…",
