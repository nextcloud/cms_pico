OC.L10N.register(
    ...
    "Incompatible plugin: PHP parse error in file \"{file}\"." : "Uygulama eki uyumsuz: \"{file}\" dosyasında PHP işleme hatası.",
    ...
    "Incompatible template: Required directory \"{file}\" not found." : "Kalıp uyumsuz: Gerekli \"{file}\" klasörü bulunamadı.",
    "Incompatible theme: Twig template \"{file}\" not found." : "Tema uyumsuz: \"{file}\" Twig kalıbı bulunamadı.",
    "Incompatible theme: Themes for Pico CMS for Nextcloud must use one of the API versions {compatApiVersions}, but this theme uses API version {apiVersion}." : "Tema uyumsuz: Nextcloud için Pico CMS temaları {compatApiVersions} API sürümlerinden birini kullanmalıdır, ancak bu uygulama eki {apiVersion} API sürümünü kullanıyor.",
    ...
    "The identifier of the website can only contain lowercase alpha numeric chars." : "Web sitesinin belirtecinde yalnız küçük harf ve rakam karakterleri bulunabilir.",
    ...
    "Line: %s" : "Satır: %s",
    "Trace" : "İz",
    "Your Nextcloud installation is incompatible with Pico CMS for Nextcloud!" : "Nextcloud kurulumunuz, Nextcloud için Pico CMS ile uyumsuz!",
    "Some of your Nextcloud apps have known incompatibilities with Pico CMS for Nextcloud. This is no-one's fault, neither are Nextcloud nor the conflicting apps to blame, this is just some technical limitation of Nextcloud's app infrastructure we can't solve in the short term. We're working on a solution! In the meantime you must remove the conflicting apps. Known conflicting apps are \"Issue Template\" and \"Terms of service\"." : "Bazı Nextcloud uygulamalarınızın Nextcloud için Pico CMS ile uyumsuzlukları olduğu biliniyor. Bu sorun ne Nextcloud ne de uyumsuz uygulamaların hatası değil. Sorunlar, Nextcloud altyapısında bulunan ve kısa sürede çözemeyeceğimiz bazı teknik sınırlamalardan kaynaklanıyor. Bir çözüm üzerinde çalışıyoruz! Ancak bu sırada, sorun çıkan uygulamaları kaldırmalısınız. \"Sorun Kalıbı\" ve \"Hizmet Koşulları\" uygulamalarının sorunlu olduğu biliniyor.",
    "If you see the error <code>\"Call to undefined method ParsedownExtra::textElements()\"</code> in Nextcloud's logs even though you've removed all conflicting apps, please don't hesitate to <a href=\"https://github.com/nextcloud/cms_pico/issues/new\">open a new Issue on GitHub</a> with a copy of the error including its stack trace and a complete list of all apps installed." : "Uyumsuz tüm uygulamaları kaldırmış olsanız bile Nextcloud günlüklerinde <code>\"Call to undefined method ParsedownExtra::textElements()\"</code> hatasını görürseniz, lütfen hatanın bir kopyasını, yığın izini ve kurulu tüm uygulamaların listesini yazarak GitHub üzerinde <a href=\"https://github.com/nextcloud/cms_pico/issues/new\">yeni bir sorun bildirmekten</a> çekinmeyin.",
    ...
    "Identifier" : "Belirteç",
    "The identifier of your website prescribes both your website's address (URL) and the name of the directory your website's files (both pages and assets) will be stored in. A website's identifier must consist of lowercase alphanumeric characters, dashes and underscores (a-z, 0-9, - and _) only." : "Web sitenizin belirteci hem web sitenizin adresini (URL) hem de web sitenizin dosyalarının (hem sayfalar hem de varlıklar) içinde saklanacağı klasörü belirtir. Bir web sitesinin belirtecinde yalnız küçük harfler, rakamlar, tire ve alt çizgi karakterleri bulunabilir (az, 0-9, - ve _).",
    "Address" : "Adres",
    "You will be able to access your website using the address (URL) shown above." : "Web sitenize yukarıdaki adresi (URL) kullanarak erişebileceksiniz.",
    "When creating a new website, Pico CMS for Nextcloud copies the website template to the following new directory in your Nextcloud." : "Yeni bir web sitesi oluştururken, Nextcloud için Pico CMS, web sitesi kalıbını Nextcloud kopyanızda aşağıdaki yeni klasöre kopyalar.",
    "You can use one of the provided themes for some greater individuality and style. If you want to use another theme, ask your Nextcloud admin - it might be possible to add your favourite theme, too!" : "Hazır temalardan birini kullanarak daha kişisel bir görünüm ve biçem elde edebilirsiniz. Başka bir tema kullanmak istiyorsanız Nextcloud yöneticinizle görüşün. Beğendiğiniz temayı ekleyebilir!",
    "Template" : "Kalıp",
    "Templates act as a starting point when creating a new website. All templates consist of a \"content\" directory (for your pages) and a \"assets\" directory (for your website's assets), which will be copied to the above folder in your Nextcloud." : "Yeni bir web sitesi oluştururken başlangıç noktası kalıplardır. Tüm kalıplarda bir \"content\" klasörü (sayfalarınız için) ve bir \"assets\" klasörü (web sitenizin varlıkları için) bulunur. Bu klasörler Nextcloud kopyanızda yukarıdaki klasöre kopyalanır.",
