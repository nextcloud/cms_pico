OC.L10N.register(
    ...
    "To add a custom template, you will need to create a new folder in apps/cms_pico/templates/" : "To add a custom template, you will need to create a new folder in apps/cms_pico/templates/",
    "Please use the sample_pico base structure: your template will need the config/ folder to be identical." : "Please use the sample_pico base structure: your template will need the config/ folder to be identical.",
    ...
    "Site Folders (Pico CMS)" : "Site Folders (Pico CMS)",
    ...
    "My new site folder" : "My new site folder",
    "Address of the website:" : "Address of the website:",
    "my_site" : "my_site",
    "Local directory:" : "Local directory:",
