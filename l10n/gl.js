OC.L10N.register(
    ...
    "Local (unencrypted)" : "Local (sen cifrar)",
    ...
    "The identifier of the website can only contain lowercase alpha numeric chars." : "O identificador do sitio web só pode conter caracteres alfanuméricos en minúscula.",
    ...
    "Just fill the form below to create your own personal website." : "Encha o seguinte formulario para crear o seu propio sitio web persoal.",
    "My example website" : "O meu exemplo de sitio web",
    "Here you can specify the name of your personal website. Your website's name will be used as website title, often shown in your website's header." : "Aquí pode especificar o nome do seu sitio web persoal. O nome do seu sitio web empregarase como título do sitio web, a miúdo amosado na cabeceira do seu sitio web.",
    "Identifier" : "Identificador",
    "The identifier of your website prescribes both your website's address (URL) and the name of the directory your website's files (both pages and assets) will be stored in. A website's identifier must consist of lowercase alphanumeric characters, dashes and underscores (a-z, 0-9, - and _) only." : "O identificador do seu sitio web prescribe tanto o enderezo do seu sitio web (URL) como o nome do directorio dos ficheiros do seu sitio web (tanto as páxinas como os activos) que se almacenarán. O identificador dun sitio web debe estar composto só por caracteres alfanuméricos en minúsculas, guións e guións baixos (az, 0 9, - e _).",
    "Address" : "Enderezo",
    ...
    "When creating a new website, Pico CMS for Nextcloud copies the website template to the following new directory in your Nextcloud." : "Ao crear un novo sitio web, Pico CMS para Nextcloud copia o modelo do sitio web no seguinte directorio no seu Nextcloud.",
    "You can use one of the provided themes for some greater individuality and style. If you want to use another theme, ask your Nextcloud admin - it might be possible to add your favourite theme, too!" : "Pode usar un dos temas fornecidos para obter unha maior individualidade e mellor estilo. Se quere empregar outro tema, pregúntelle ao administrador do seu Nextcloud. É posíbel que sexa factíbel engadir o seu tema favorito.",
    "Template" : "Modelo",
    "Templates act as a starting point when creating a new website. All templates consist of a \"content\" directory (for your pages) and a \"assets\" directory (for your website's assets), which will be copied to the above folder in your Nextcloud." : "Os modelos actúan como punto de partida ao crear un novo sitio web. Todos os modelos consisten nun directorio «content» (para as súas páxinas) e un directorio «assets» (para os activos do seu sitio web), que se copiarán no cartafol anterior no seu Nextcloud.",
