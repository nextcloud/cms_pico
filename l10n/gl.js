OC.L10N.register(
    ...
    "Incompatible plugin: Plugin file \"{file}\" not found." : "Engadido incompatíbel: non se atopou o ficheiro do engadido «{file}».",
    "Incompatible plugin: PHP parse error in file \"{file}\"." : "Engadido incompatíbel: produciuse un erro de análise PHP no ficheiro «{file}».",
    "Incompatible plugin: Plugin class \"{class}\" not found." : "Engadido incompatíbel: non se atopou o engadido da clase «{class}».",
    "Incompatible plugin: Plugins for Pico CMS for Nextcloud must use one of the API versions {compatApiVersions}, but this plugin uses API version {apiVersion}." : "Engadido incompatíbel: os engadidos para Pico CMS para Nextcloud deben usar unha das versións {compatApiVersions} da API, mais este engadido usa a versión {apiVersion} da API.",
    "Incompatible template: Required directory \"{file}\" not found." : "Modelo incompatíbel: non se atopou o directorio requirido «{file}».",
    "Incompatible theme: Twig template \"{file}\" not found." : "Tema incompatíbel: non se atopou o modelo «{file}» para Twig.",
